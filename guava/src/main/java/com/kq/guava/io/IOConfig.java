...
public class IOConfig {
    ...
    public static final String COPY_FILE = getOSPath()+ File.separator+"copyfile";
    ...
    public static final String TOUCH_FILE = getOSPath()+ File.separator+"touchfile";

    public static final String ITER_PATH = "C:\\temp";
