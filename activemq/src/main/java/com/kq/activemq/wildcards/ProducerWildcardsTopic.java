 ...
 * @date 2019-08-05
 */
public class ProducerWildcardsTopic {

    public static final String TOPIC_NAME = "com.wildcard.*.1";
...
//            session = conn.createSession(false, Session.AUTO_ACKNOWLEDGE); acknowledge
            ...
            // 6、创建一条文本消息
            String text = "ProducerWildcards ! Hello world! From: " + Thread.currentThread().getName() + " : "
